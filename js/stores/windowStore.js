...
const newFrame = (frameOpts, openInForeground, insertionIndex, nextKey) => {
  ...
  if (insertionIndex === undefined) {
    ...
    console.log('----parnetFrameKey: ', parentFrameKey)
    console.log('----frameOpts.indexByFrameKey: ', frameOpts.indexByFrameKey)
    if (!frameOpts.prependIndexByFrameKey) {
      insertionIndex++
      console.log('increased insertionIndex: ', insertionIndex)
    }
    if (insertionIndex === -1) {
      insertionIndex = frames.size
      console.log('reset insertionIndex: ', insertionIndex)
  ...
  if (frameStateUtil.isFrameKeyPinned(frames, parentFrameKey)) {
    insertionIndex = 0
    console.log('reset insertionIndex because was pinned: ', insertionIndex)
  }
  ...
  console.log('insertionIndex3:', insertionIndex)
